...
class MailService {
    ...
    void sendMail(NotificationEmail notificationEmail) {
        MimeMessagePreparator messagePreparator = mimeMessage -> {
            ...
            messageHelper.setFrom("springphototraveller@email.com");
        ...
        try {
            ...
            throw new SpringPhotoTravellerException("Exception occurred when sending mail to " + notificationEmail.getRecipient(), e);
        }
    }
